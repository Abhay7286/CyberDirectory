...
export default defineConfig(({ mode }) => ({
  optimizeDeps: {
    include: [
      ...
      "@radix-ui/react-tooltip", "@supabase/supabase-js", "@tanstack/react-query",
      "axios", "class-variance-authority", "clsx", "cmdk", "date-fns", "embla-carousel-react",
      "framer-motion", "input-otp", "lucide-react", "next-themes", "react", "react-day-picker",
      "react-dom", "react-hook-form", "react-resizable-panels", "react-router-dom",
